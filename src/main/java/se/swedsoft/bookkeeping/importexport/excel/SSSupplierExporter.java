...
public class SSSupplierExporter {
    // Column names
    public static final String LEVERANTÖRSNUMMER = "Leverantörsnummer";
    ...
    public static final String VÅRT_KUNDNUMMER = "Vårt kundnummer";
    ...
    private void writeSuppliers(SSWritableExcelSheet pSheet ) throws WriteException {
        ...
        iColumns.setString( 0, SSSupplierExporter.LEVERANTÖRSNUMMER     , iCellFormat);
        ...
        iColumns.setString( 9, SSSupplierExporter.VÅRT_KUNDNUMMER       , iCellFormat);
