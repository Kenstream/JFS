...
public class SSProductExporter {
    ...
    public static final String FÖRSÄLJNINGSPRIS = "Försäljningspris";
    public static final String INKÖPSPRIS = "Inköpspris";
    ...
    public static final String LEVERANTÖR = "Leverantör";
    public static final String LEVERANTÖRENS_ARTIKEL_NUMMER = "Leverantörens artikel nummer";
    public static final String BESTÄLLNINGSPUNKT = "Beställningspunkt";
    ...
    private void writeSheet(SSWritableExcelSheet pSheet ) throws WriteException {
        ...
        iColumns.setString( 2, FÖRSÄLJNINGSPRIS             , iCellFormat);
        iColumns.setString( 3, INKÖPSPRIS                   , iCellFormat);
        ...
        iColumns.setString( 9, LEVERANTÖR                   , iCellFormat);
        iColumns.setString(10, LEVERANTÖRENS_ARTIKEL_NUMMER , iCellFormat);
        iColumns.setString(11, BESTÄLLNINGSPUNKT            , iCellFormat);
